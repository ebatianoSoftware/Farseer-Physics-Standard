    ...
    public class Path
    {
        ...
        public Vector2 GetPosition(float time)
        {
            ...
            if (Closed)
            {
                ...
                temp = new Vector2(MathHelper.CatmullRom(ControlPoints[p0].X, ControlPoints[p1].X, ControlPoints[p2].X, ControlPoints[p3].X, lt),
        ...
        public Vector2 GetPositionNormal(float time)
        {
            ...
            Vector2 output = Vector2.Normalize(new Vector2(-temp.Y, temp.X));
            return output;
        }
